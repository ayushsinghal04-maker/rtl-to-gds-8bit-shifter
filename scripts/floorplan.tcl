...
create_lib -ref_lib $PDK_PATH/lib/ndm/saed32rvt_c.ndm SHIFTER_LIB_1

read_verilog {./../DC/results/shifter_8bit.mapped.v} -library SHIFTER_LIB_1 -design shifter_8bit -top shifter_8bit
...
#scenario10:
initialize_floorplan -core_utilization 0.75 -coincident_boundary true -core_offset {1 2} -shape U -orientation W
